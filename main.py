...
for j in range(number_of_test):
    ...
    # Testing
    list_correct_train.append(experimental(W10, W11, W12, W13, count_epoch, avg_error, is_train=False))
    list_correct_test.append(experimental(W10, W11, W12, W13, count_epoch, avg_error, is_train=True))

# graph of correct prediction of train and test data
...
x_values = list(range(1, number_of_test + 1))
